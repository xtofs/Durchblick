...
/// <summary>
/// Data attribute that resolves a specimen method from the test assembly and feeds decoded inputs
/// to a <c>[Theory]</c>. Annotate a test with the specimen's type and method name; the test receives
/// inputs decoded from that method, matched to its parameters by type:
/// <list type="bullet">
...
public sealed class SpecimenAttribute(string type, string method) : DataAttribute
{
    public override IEnumerable<object[]> GetData(MethodInfo testMethod)
    {
        var specimen = SpecimenLoader.Resolve(type, method);
